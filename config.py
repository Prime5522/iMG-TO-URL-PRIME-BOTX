...
API_HASH = os.getenv("API_HASH", "27148454")
API_ID = int(os.getenv("API_ID", "f668c20d77d1a8feee31afdc810f8ac4"))
BOT_TOKEN = os.getenv("BOT_TOKEN", "7509429916:AAFCto9RZEQlCmvd4rHCoz9Cvi863nI9_ZM")
